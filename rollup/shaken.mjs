(function (show, type) {
  ...
  function invalidFuture$1(it, at, m, s){
  ...
  function ensureError(value, fn){
    ...
    var e = error$1(message);
    captureStackTrace(e, fn);
    return e;
  }

  function makeError$1(caught, callingFuture, extraContext){
    var origin = ensureError(caught, makeError$1);
    var e = error$1(origin.message);
  ...
  function throwInvalidFuture(it, at, m, s){
    throw invalidFuture$1(it, at, m, s);
  }
  ...
  Node.prototype._interpret = function Node$interpret(rec, rej, res){
    ...
    try{
      ...
      rec(makeError$1(e, this, this.context));
      open = false;
      return noop;
    }
    cont();
